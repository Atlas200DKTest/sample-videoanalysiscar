...
{
    proto_dir=$app_path/VideoAnalysisPost
    pb_h_file=$app_path/VideoAnalysisPost/video_analysis_message.pb.h
    proto_file=$app_path/VideoAnalysisPost/video_analysis_message.proto
